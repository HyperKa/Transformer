...
public class Main {
    public static void main(String[] args) throws IOException, IllegalAccessException {
        ...
        String datasetPath = ConfigConstants.MODEL_SAVE_PATH;
        ...
        TransformerModel model = new TransformerModel(vocabSize, embeddingDim, numHeads, hiddenDim, numLayers, numClasses);
        CrossEntropyLoss lossFunction = new CrossEntropyLoss();
        OptimizerAdam optimizer = new OptimizerAdam(model, learningRate); // Используем ваш Adam
